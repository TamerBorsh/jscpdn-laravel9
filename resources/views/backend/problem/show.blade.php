                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <select class="form-select" id="category" name="category" disabled>
                                                ...
                                                <option value="3" @if ($problem->category == '3') selected @endif>
                                                    ملاحظة</option>
                                                <option value="4" @if ($problem->category == '4') selected @endif>
                                                    استفسار</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class=" col-md-12 alert alert-primary text-center p-2"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <select class="form-select" id="importance" name="importance" disabled>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-12">
                                                ...
                                                <textarea class="form-control" id="reply" name="reply" rows="3" disabled>{{ $problem->reply }}</textarea>
                                            </div>
                                        </div>
